...
public class TimKiemView extends JFrame {
    ...
    private void init() {
        ...
        // *** Create JTextArial
        this.jta_VanBan = new JTextArea(6, 5);
        this.jta_VanBan.setFont(f1);

        // *** Create JScrollPane và thêm JTextArea vào JScrollPane
        JScrollPane jScrollPane = new JScrollPane(jta_VanBan,
        ...
        jPanel_center_top.add(jScrollPane, BorderLayout.CENTER);
